...
//
//public class donut_order_also extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
//
//    public static Order donutOrders = new Order();
//    //i think these strings count as being hardcoded
//    public static final String[] sizes = {"Glazed Yeast Donut", "Tall", "Grande", "Venti"};
...
//        subtotal.setText(String.format("$"+"%.2f", donutOrders.orderPrice()));
//    }
//
//    private void updateBalance(){
//        double sum = 0;
//        for(MenuItem items: donutOrders.getOrder()){
//            sum += items.itemPrice();
//        }
//        subtotal.setText(String.format("$"+"%.2f", donutOrders.orderPrice()));
...
//        }
//
//        for (MenuItem num : donutOrders.getOrder()) {
//            if (num.compare(item)) {
...
//        donutOrders.getOrder().remove(position);
...
//        coffeeAdapter = new coffeeAdapt(donutOrders.getOrder());
//
